...
module.exports = {
    ...
    async execute(message, args) {
        ...
        let i = 0;
        menu.setTitle(`Selected user: ${members[i][0]}`).setThumbnail(members[i][1]).setFooter(`${i + 1}/${members.length}`).setDescription('<a:loading:679334829359366165> *In the process of banning a user...*\n\nUse ⬅️/➡️ to navigate pages.\nUse ✅ to confirm and kick the selected user.\nUse ❌ to cancel any time.');
